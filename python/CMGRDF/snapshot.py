...
class Snapshot(Target):
    ...
    def __init__(self, 
        ...
        self.columnSel  = ([] if columnSel is None else ([columnSel] if type(columnSel) == str else list(columnSel)))
        self.columnVeto = ([] if columnVeto is None else ([columnVeto] if type(columnVeto) == str else list(columnVeto)))
